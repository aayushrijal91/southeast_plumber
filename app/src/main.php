                ...
                <div class="w-fit flex flex-wrap gap-x-5">
                    <p class="w-fit hidden lg:flex items-center leading-none text-secondary font-merge text-xl gap-x-3">
                        <svg width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.5 0L15.1501 6.476L22.4371 7.9463L17.4061 13.419L18.2595 20.8037L11.5 17.71L4.74047 20.8037L5.59394 13.419L0.56285 7.9463L7.84985 6.476L11.5 0Z" fill="#FF6969" />
                        </svg>
                        5 Star Reviews
                    </p>
                    ...
                    <p class="w-fit hidden xl:flex items-center leading-none text-secondary font-merge text-xl gap-x-3">
                        ...
                        Servicing All of South East Melbourne
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="w-fit flex flex-wrap gap-3">
                    <a href="#form" class="w-[53px] md:w-fit flex justify-center items-center rounded-lg leading-none shadow-md bg-tertiary text-white font-bold h-[53px] md:px-7">
...
<section class="banner bg-primary">
    <div class="container">
        <div class="w-full xl:w-5/12 py-20 md:pb-24 md:pt-32">
            ...
            <h1 class="text-5xl md:text-64 font-merge text-white leading-none pt-4">Your Fast, Local <span class="text-tertiary">South East Melbourne</span> Plumber Experts</h1>

            <div class="w-fit flex flex-wrap gap-3 mt-10 md:mt-20">
                <a href="#form" class="w-fit flex items-center rounded-lg leading-none shadow-md bg-tertiary text-white font-bold h-[53px] px-7">Book Online</a>
        ...
        <div class="flex flex-wrap justify-center lg:-mx-2 gap-y-10">
            ...
            <div class="w-full md:w-1/3 lg:w-1/5 px-10 md:px-2">
                <div class="group text-center flex flex-col items-center">
                    ...
                    <p class="text-secondary group-hover:text-primary duration-150 font-merge text-2xl md:text-3xl mt-5 md:mt-10 capitalize">Local South Eastern Melbourne Team</p>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/3 lg:w-1/5 px-10 md:px-2">
                <div class="group text-center flex flex-col items-center">
                    ...
                    <p class="text-secondary group-hover:text-primary duration-150 font-merge text-2xl md:text-3xl mt-5 md:mt-10 capitalize">Discounts For Eastern Locals</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="w-full xl:w-1/2 md:px-3">
                <div class="h-full bg-primary rounded-10 flex flex-wrap overflow-clip text-white shadow-lg">
                    <div class="w-full md:w-5/12 grow py-10 px-3 md:p-14">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge py-5">Receive <br /><span class="text-tertiary">$100 Off</span></p>
            ...
            <div class="w-full xl:w-1/2 md:px-3">
                <div class="h-full bg-primary rounded-10 flex flex-wrap overflow-clip text-white shadow-lg">
                    <div class="w-full md:w-5/12 grow py-10 px-3 md:p-14">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge py-5">Receive <br /><span class="text-tertiary">$50 Off</span></p>
                        <p class="text-base md:text-lg md:pt-5">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5"><span class="text-tertiary">Free</span> Inspection</p>
                    </div>
                    <div class="w-full">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5">Receive <span class="text-tertiary">10% Off</span></p>
                    </div>
                    <div class="w-full">
            ...
            <div class="w-full md:w-2/3 lg:w-1/3 md:px-3">
                <div class="h-full bg-primary rounded-10 overflow-clip text-white shadow-lg">
                    <div class="w-full grow py-10 px-3 md:p-14 text-center">
                        ...
                        <p class="text-4xl md:text-5xl leading-none font-merge pt-5">Senior <span class="text-tertiary">Discounts</span></p>
                    </div>
                    <div class="w-full">
...
<section class="service py-20 md:py-32 bg-secondary" id="services">
    <div class="container">
        <p class="capitalize text-4xl md:text-5xl lg:text-64 font-merge text-white text-center leading-none">Fast south east melbourne <span class="text-tertiary">Services</span></p>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 md:px-3">
                    <div class="<?= ($key == 0) ? 'bg-primary' : 'bg-light' ?> rounded-10 overflow-clip h-full shadow-lg">
                        ...
                        <div class="flex flex-col items-center gap-y-10 grow py-10 md:py-14 px-5 md:px-10 text-center">
                            ...
                            <?php if ($key == 0) : ?>
                                <a href="tel:<?= $phone_number ?>" class="w-fit flex items-center rounded-lg leading-none shadow-md bg-tertiary text-white font-bold h-[53px] px-7">Call Now</a>
                            <?php else : ?>
    ...
    <div class="container py-24 md:py-40">
        <div class="rounded-10 bg-secondary text-white overflow-clip shadow-lg flex flex-wrap items-end xl:items-center justify-between">
            <div class="w-full md:w-7/12 px-3 xl:px-24 py-10">
                <p class="text-4xl xl:text-5xl font-merge leading-none">Professional Licensed Plumbers in South East Melbourne</p>
                ...
                <div class="description text-base xl:text-lg py-5 xl:py-14">
                    ...
                    <p>At Eastern Plumber, we understand the inconvenience these issues bring. Our team of skilled professionals is available round the clock, even on holidays, to provide efficient and reliable plumbing services.</p>
                </div>
        ...
        <div class="rounded-10 bg-secondary text-white overflow-clip shadow-lg flex flex-wrap items-end xl:items-center justify-between mt-7 md:mt-16">
            ...
            <div class="w-full md:w-7/12 px-3 xl:px-24 py-10 order-1 md:order-2">
                <p class="text-4xl xl:text-5xl font-merge leading-none">Local Specialist Plumbers in South East Melbourne</p>

                <div class="description text-base xl:text-lg py-5 xl:py-14">
                    <p>Whether you need a toilet repair or Leak repair or installation, or there’s a problem with your hot water, our qualified Eastern Plumber Melbourne will fix your plumbing emergency today so you can breathe a sigh of relief.</p>
    ...
    <div class="flex flex-wrap justify-center items-center gap-y-16 relative mt-14 md:mt-32 lg:-mx-3">
        ...
        <div class="w-full md:w-1/2 xl:w-3/12 md:px-3">
            <div class="bg-white shadow-lg rounded-10 py-10 px-8 flex flex-col items-center justify-between text-center gap-7 relative z-40">
                ...
                <div class="w-fit flex flex-wrap gap-3">
                    <a href="#form" class="w-fit flex items-center rounded-lg leading-none shadow-md bg-tertiary text-white font-bold h-[53px] px-5">Book Online</a>
            ...
            <div class="w-full lg:w-7/12">
                <div class="bg-secondary rounded-10 text-center text-white overflow-clip">
                    <div class="px-3 md:px-20 lg:px-5 xl:px-20 pt-14 md:pt-20 pb-10">
                        <p class="capitalize text-4xl md:text-64 font-merge text-tertiary text-center leading-none">Why Choose<br /> <span class="text-white">eastern plumber?</span></p>

                        <p class="text-base md:text-lg py-5 md:py-14">
                            We are licensed, insured and qualified plumbers in South East Melbourne, highly experienced in hot water systems repairs & installation, blocked drains, leaking detection and Emergency commercial and residential plumbing services.
                        </p>
            ...
            <div class="w-full md:w-10/12 lg:w-5/12 flex flex-col gap-y-7 md:gap-y-14 px-3 md:px-16 lg:px-5 xl:px-16">
                <div class="w-full flex flex-wrap items-center text-light">
                    ...
                    <div class="w-9/12 md:w-10/12">
                        ...
                        <p class="text-sm md:text-lg">We travel to all areas of South East Melbourne</p>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap justify-between items-center">
                    ...
                    <div class="w-fit">
                        <svg width="140" height="24" viewBox="0 0 140 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 0L15.8088 6.75757L23.4127 8.2918L18.1628 14.0024L19.0534 21.7082L12 18.48L4.94658 21.7082L5.83715 14.0024L0.587322 8.2918L8.19115 6.75757L12 0Z" fill="#FF6969" />
                            <path d="M41 0L44.8088 6.75757L52.4127 8.2918L47.1628 14.0024L48.0534 21.7082L41 18.48L33.9466 21.7082L34.8372 14.0024L29.5873 8.2918L37.1912 6.75757L41 0Z" fill="#FF6969" />
                            <path d="M70 0L73.8088 6.75757L81.4127 8.2918L76.1628 14.0024L77.0534 21.7082L70 18.48L62.9466 21.7082L63.8372 14.0024L58.5873 8.2918L66.1912 6.75757L70 0Z" fill="#FF6969" />
                            <path d="M99 0L102.809 6.75757L110.413 8.2918L105.163 14.0024L106.053 21.7082L99 18.48L91.9466 21.7082L92.8372 14.0024L87.5873 8.2918L95.1912 6.75757L99 0Z" fill="#FF6969" />
                            <path d="M128 0L131.809 6.75757L139.413 8.2918L134.163 14.0024L135.053 21.7082L128 18.48L120.947 21.7082L121.837 14.0024L116.587 8.2918L124.191 6.75757L128 0Z" fill="#FF6969" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="h-full bg-primary rounded-10 flex flex-wrap overflow-clip text-white shadow-lg">
                    <div class="w-5/12 grow px-3 py-10 md:px-5 lg:p-14">
                        <div class="flex flex-col justify-between h-full">
                            <div class="w-full">
                                <p class="text-4xl md:text-5xl leading-none font-merge">Fix Now, <br /><span class="text-tertiary">Pay Later</span></p>
            ...
            <div class="w-full xl:w-5/12 lg:px-3">
                <div class="h-full bg-secondary rounded-10 py-10 px-5 md:p-14 text-center flex flex-col items-center justify-between gap-y-10 xl:gap-y-5">
                    <svg width="149" height="50" viewBox="0 0 149 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.7421 22.0786C16.7421 20.7791 16.8316 19.3403 17.3949 18.257C17.65 17.7664 17.9888 17.3799 18.4669 17.0999C18.9528 16.8153 19.7232 16.5591 20.9629 16.5591H37.846V12.0137H20.9629C19.0858 12.0137 17.486 12.4068 16.17 13.1775C14.8462 13.9526 13.9511 15.0271 13.3621 16.1599C12.2371 18.3234 12.1967 20.7807 12.1967 22.0786H11.2227V23.3773H17.7162V22.0786H16.7421Z" fill="#FF6969" />
                        <path d="M18.8535 37.6626H37.8462V33.1172H19.8602C20.0091 34.4131 19.9376 35.8988 19.1827 37.1766C19.081 37.3488 18.9711 37.5107 18.8535 37.6626Z" fill="#FF6969" />
                    ...
                    <p class="font-merge text-white text-4xl md:text-5xl capitalize"><span class="text-tertiary">24/7</span> general & emergency plumbing</p>
...
<section class="bg-tertiary py-24 lg:py-40 form">
    <div class="container" id="form">
        <div class="bg-primary flex flex-wrap rounded-10 overflow-clip items-center shadow-lg">
            ...
            <div class="w-full xl:w-fit xl:flex-1 text-center px-4 lg:px-16 py-10 order-1 xl:order-2">
                <p class="capitalize text-4xl md:text-5xl lg:text-64 font-merge text-white text-center leading-none"><span class="text-tertiary">Book Online</span> Today & Claim $50 Off</p>
